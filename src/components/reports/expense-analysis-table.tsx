...
export function ExpenseAnalysisTable({ categories }: { categories: CategoryBreakdown[] }) {
  return (
    <Card className="shadow-sm">
      ...
      <CardContent className="p-0">
        {categories.length === 0 ? (
          <p className="px-6 pb-6 text-sm text-muted-foreground">No expenses recorded for this period.</p>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
